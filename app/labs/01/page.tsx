                ...
                <section>
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        <p className="mb-6 text-neutral-300">
                            L&apos;objectif de ce laboratoire est de mettre en place une chaîne
                            CI/CD moderne similaire à celle utilisée dans de nombreuses
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        ...
                        <div className="mt-8 rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-6">
                            ...
                            <p className="mt-2 text-neutral-300">
                                Automatiser complètement la chaîne afin qu&apos;un simple push Git
                                déclenche toutes les vérifications nécessaires avant la
...
└── README.md`}
                        ...
                        <div className="mt-6 rounded-xl border border-neutral-800 bg-neutral-900 p-5">
                            <p className="text-sm text-neutral-400">
                                ...
                                configuration Docker utilisés dans ce laboratoire sont
                ...
                <section>
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        <p className="mb-6 text-neutral-300">
                            ...
                            d&apos;automatiser l&apos;ensemble du cycle de livraison. Le projet s&apos;appuie
                            sur une stratégie Git simple : chaque évolution est développée
                            dans une branche dédiée, validée automatiquement puis intégrée via
                            Pull Request avant publication.
                        </p>
...
Docker Hub`}
                        ...
                        <div className="mt-8 rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-6">
                            ...
                            <p className="mt-3 text-neutral-300">
                                ...
                                génération de l&apos;image Docker puis publication sur Docker Hub. Le
                                site que vous consultez actuellement est issu de cette chaîne
                                automatisée.
                            </p>
                        </div>
                    </div>
          ...
          tags: portfolio:latest`}
                ...
                <section>
                    ...
                    <p className="mb-8 text-neutral-300">
                        ...
                        construit automatiquement une image Docker de l&apos;application. Cette
                        image est ensuite publiée dans Docker Hub afin de pouvoir être
