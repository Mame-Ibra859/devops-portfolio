            ...
            <section className="border-b border-neutral-800">
                <div className="mx-auto max-w-6xl px-6 py-20">
                    ...
                    <p className="mt-6 max-w-3xl text-lg text-neutral-300">
                        ...
                        L'application Next.js que vous consultez actuellement est construite,
                        validée, conteneurisée et publiée automatiquement grâce à cette chaîne
                        CI/CD. Chaque évolution du site suit le même processus : validation du
                        code, contrôle qualité, construction de l'image Docker puis publication
                ...
                <section>
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        <p className="mb-6 text-neutral-300">
                            L'objectif de ce laboratoire est de mettre en place
                            une chaîne CI/CD moderne similaire à celle utilisée
                            dans de nombreuses équipes DevOps afin de construire l'image Docker.
                        </p>
                ...
                <section>
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        <p className="text-neutral-300 mb-6">
                            Avant l'automatisation de la chaîne CI/CD, chaque modification du
                            projet nécessitait plusieurs opérations manuelles :
                        ...
                        <div className="mt-8 rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-6">
                            ...
                            <p className="mt-2 text-neutral-300">
                                Automatiser complètement la chaîne afin qu'un
                                simple push Git déclenche toutes les vérifications
                                nécessaires avant la publication d'une image Docker.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        <p className="mb-6 text-neutral-300">
                            ...
                            le code applicatif, les pipelines CI/CD et les artefacts
                            nécessaires à la conteneurisation.
                        </p>
...
└── README.md`}
                        ...
                        <div className="mt-8 grid gap-4 md:grid-cols-2">
                            ...
                            <div className="rounded-xl bg-neutral-800 p-4">
                                ...
                                <p className="mt-2 text-sm text-neutral-400">
                                    Construction de l'image Docker utilisée pour le déploiement.
                                </p>
                            </div>
                        ...
                        <div className="mt-6 rounded-xl border border-neutral-800 bg-neutral-900 p-5">
                            <p className="text-sm text-neutral-400">
                                L'ensemble du code source, des workflows GitHub Actions et de la
                                configuration Docker utilisés dans ce laboratoire sont disponibles
                                publiquement.
                            </p>
                ...
                <section>
                    ...
                    <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-8">
                        <p className="mb-6 text-neutral-300">
                            ...
                            d'automatiser l'ensemble du cycle de livraison. Le projet
                            s'appuie sur une stratégie Git simple : chaque évolution est
                            développée dans une branche dédiée, validée automatiquement
                            puis intégrée via Pull Request avant publication.
                        </p>
...
└── ci/release`}
                        ...
                        <p className="mt-4 text-neutral-400">
                            ...
                            CI/CD sont également versionnés afin de pouvoir faire évoluer
                            les workflows sans impacter directement la branche principale.
                        </p>
...
Docker Hub`}
                        ...
                        <div className="mt-8 rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-6">
                            ...
                            <p className="mt-3 text-neutral-300">
                                ...
                                génération de l'image Docker puis publication sur Docker Hub.
                                Le site que vous consultez actuellement est issu de cette
                                chaîne automatisée.
                            </p>
                        </div>
                    </div>
                ...
                <section>
                    ...
                    <p className="mb-8 text-neutral-300">
                        Les pipelines GitHub Actions automatisent l'ensemble du cycle de
                        livraison. Chaque workflow possède une responsabilité précise :
          ...
          tags: portfolio:latest`}
                ...
                <section>
                    ...
                    <p className="mb-8 text-neutral-300">
                        ...
                        Cette image est ensuite publiée dans Docker Hub afin de pouvoir
                        être utilisée prochaine dans Kubernetes.
                    </p>
                        ...
                        <ul className="space-y-5">
                            <li>
                                ...
                                <p className="text-neutral-400">
                                    Harmonisation des règles entre Next.js,
                                    TypeScript et Prettier.
                                </p>
                            </li>
                            ...
                            <li>
                                ...
                                <p className="text-neutral-400">
                                    Configuration sécurisée des identifiants Docker
                                    Hub dans GitHub Actions.
                                </p>
                            </li>
                            ...
                            <li>
                                ...
                                <p className="text-neutral-400">
                                    Séparation claire entre validation, merge et
                                    release afin d'éviter les déploiements non
                                    contrôlés.
                                </p>
                            </li>
                        </ul>
                    ...
                    <div className="rounded-2xl border border-green-500/20 bg-green-500/5 p-8">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span>
                                    Chaque Push déclenche automatiquement les
                                    validations.
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                <CheckCircle2 className="text-green-400" />
                                <span>
                                    Chaque Pull Request est contrôlée avant fusion.
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                <CheckCircle2 className="text-green-400" />
                                <span>
                                    Chaque Merge sur main déclenche une release.
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                <CheckCircle2 className="text-green-400" />
                                <span>
                                    Une image Docker versionnée est publiée
                                    automatiquement.
                                </span>
                            </div>
                        </div>
                        ...
                        <p className="mt-8 text-neutral-300">
                            Ce laboratoire établit la fondation DevOps utilisée
                            par tous les laboratoires suivants du portfolio.
                            Il démontre la maîtrise des principes Git, CI/CD,
                            Docker et automatisation des déploiements.
                        </p>
                    </div>
                </section>
            </div>
