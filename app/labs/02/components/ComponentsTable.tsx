  ...
  return (
    <section>
      ...
      <p className="mb-6 max-w-4xl text-sm leading-7 text-neutral-400 sm:mb-8 sm:text-base sm:leading-8">
        Kubernetes repose sur plusieurs ressources qui collaborent afin
        d'assurer le déploiement, l'exposition, la configuration et la
        persistance de l'application. Cette section présente uniquement les
        composants réellement utilisés dans ce laboratoire.
      </p>
