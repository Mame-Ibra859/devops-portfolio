  ...
  return (
    <section>
      <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-10">
        <h3 className="text-2xl font-bold">4.6 Publication via Ingress</h3>
        ...
        <p className="mt-4 leading-8 text-neutral-300">
          ...
          <span className="font-semibold text-cyan-400">Ingress</span> associé à{" "}
          <span className="font-semibold text-cyan-400">Traefik</span>, installé
          automatiquement avec K3s.
        </p>
...
Pod`}
        ...
        {/* EXPLICATION */}
        <div className="mt-10">
          <h4 className="text-xl font-semibold">Rôle de l&apos;Ingress</h4>
          ...
          <p className="mt-4 leading-7 text-neutral-300">
            Lorsqu&apos;un utilisateur accède au portfolio, la requête arrive
            d&apos;abord sur l&apos;adresse IP publique du serveur. Traefik
            intercepte ensuite cette requête et consulte les règles définies
            dans l&apos;Ingress afin de déterminer vers quel Service Kubernetes
            rediriger le trafic.
          </p>

          <p className="mt-4 leading-7 text-neutral-300">
            Le Service se charge ensuite de distribuer la requête vers l&apos;un
            des Pods du portfolio.
          </p>
        </div>
        ...
        <Accordion className="mt-10">
          ...
          >
            <AccordionTrigger>Configuration de l&apos;Ingress</AccordionTrigger>
      ...
      - path: /
        ...
        <div className="mt-10 rounded-2xl border border-green-500/20 bg-green-500/10 p-6">
          ...
          <p className="mt-4 leading-7 text-green-100">
            ...
            cluster via l&apos;adresse IP publique du VPS. Les requêtes sont
            reçues par Traefik puis routées automatiquement vers
            l&apos;application déployée sur Kubernetes.
          </p>

          <p className="mt-4 leading-7 text-green-100">
            Une évolution prévue consiste à associer un{" "}
            <span className="font-semibold">nom de domaine</span> ainsi
            qu&apos;un <span className="font-semibold">certificat TLS</span>{" "}
