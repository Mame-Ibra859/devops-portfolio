    ...
    <section>
      <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6 lg:p-10">
        ...
        <p className="mt-4 text-sm leading-7 text-neutral-300 sm:mt-6 sm:text-base sm:leading-8">
          Une fois le cluster disponible, la première étape consiste à organiser
          les ressources. Kubernetes fournit les
          <span className="font-semibold text-white"> Namespaces</span>, qui
          permettent de créer des espaces logiques indépendants à l'intérieur
          d'un même cluster.
        </p>
       ...
       └── PVC`}
        ...
        <div className="mt-8 overflow-hidden rounded-2xl border border-neutral-700 bg-neutral-950 sm:mt-10">
          <div className="flex items-center gap-3 border-b border-neutral-800 px-4 py-3 sm:px-5 sm:py-4">
            ...
            <span>Création des Namespaces</span>
          </div>
...
postgres`} */}
            <img
              src="/labs/02/namespace-result.png"
              alt="Résultat de la commande kubectl get namespaces"
              className="mt-5 rounded-lg border border-neutral-700"
            />
          </pre>

          <p className="mt-4 text-sm leading-7 text-cyan-100 sm:mt-6 sm:text-base">
            Les ressources du portfolio et celles de PostgreSQL sont maintenant
            totalement séparées. Cette organisation simplifie les opérations
            d'administration, les futures évolutions de la plateforme ainsi que
