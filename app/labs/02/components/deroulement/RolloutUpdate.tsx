    ...
    <section>
      <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6 lg:p-10">
        ...
        <p className="mt-4 text-sm leading-7 text-neutral-300 sm:mt-6 sm:text-base sm:leading-8">
          ...
          conteneurs. Elle permet également de déployer de nouvelles versions
          d&apos;une application sans interruption de service.
        </p>

        <p className="mt-3 text-sm leading-7 text-neutral-300 sm:mt-4 sm:text-base sm:leading-8">
          Après une modification du code source, le pipeline CI/CD construit une
          nouvelle image Docker puis la publie dans Docker Hub. Une nouvelle
          version devient alors disponible pour le cluster.
        </p>
...
fayemameibra/devops-portfolio:v0.0.2`}
        ...
        <div className="mt-12">
          <div className="flex items-center gap-3">
            <RefreshCw className="text-cyan-400" size={22} />
          ...
          <p className="mt-5 leading-7 text-neutral-300">
            Kubernetes permet d&apos;indiquer au Deployment qu&apos;une nouvelle
...
-n nextjs-app`}
          ...
          <p className="mt-5 leading-7 text-neutral-300">
            Le Deployment détecte immédiatement le changement et démarre un
            processus de mise à jour progressive.
          </p>
        </div>

        {/* ROLLING UPDATE */}
        <div className="mt-12">
          <h4 className="text-xl font-semibold">Rolling Update</h4>

          <p className="mt-5 leading-7 text-neutral-300">
            Kubernetes ne supprime jamais tous les Pods simultanément. Les
            anciens Pods sont remplacés progressivement par de nouveaux Pods
            exécutant la nouvelle version.
          </p>
...
v0.0.2   v0.0.2   v0.0.2`}
          ...
          <p className="mt-5 leading-7 text-neutral-300">
            Durant toute l&apos;opération, le Service continue de répartir les
            requêtes entre les Pods disponibles. Les utilisateurs peuvent donc
            accéder au portfolio sans interruption.
          </p>
        </div>

        {/* STATUS */}
        <div className="mt-12">
          <h4 className="text-xl font-semibold">Suivi du déploiement</h4>

          <p className="mt-5 leading-7 text-neutral-300">
            Kubernetes permet de suivre l&apos;avancement de la mise à jour en
            temps réel.
          </p>
...
-n nextjs-app`}
        ...
        <div className="mt-12">
          ...
          <p className="mt-5 leading-7 text-neutral-300">
            Si la nouvelle version présente un défaut critique, Kubernetes
            permet de revenir instantanément à la version précédente.
          </p>
