...
import { Boxes, ShieldCheck, CheckCircle2 } from "lucide-react";

export default function PortfolioDeployment() {
  return (
    <section>
      <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-10">
        <h3 className="text-2xl font-bold">4.4 Déploiement du Portfolio</h3>
        ...
        <p className="mt-4 leading-8 text-neutral-300">
          ...
          <span className="font-semibold text-cyan-400">image Docker</span>{" "}
          construite et publiée automatiquement lors du{" "}
          <span className="font-semibold text-cyan-400">Lab 01</span>.
        ...
        {/* IMAGE DOCKER */}
        <div className="mt-10">
          <h4 className="text-xl font-semibold">Image utilisée</h4>
          ...
          <p className="mt-5 leading-7 text-neutral-300">
            Cette image est produite automatiquement par le pipeline GitHub
            Actions présenté dans le Lab 01. Le cluster Kubernetes récupère
            ensuite cette image depuis le registre Docker Hub afin de créer les
        ...
        <div className="mt-12">
          ...
          <p className="mt-5 leading-7 text-neutral-300">
            L&apos;application est déployée grâce à une ressource Kubernetes de
            type <span className="font-semibold text-cyan-400">Deployment</span>
            .
          </p>
          ...
          <Accordion className="mt-6">
            ...
            >
              <AccordionTrigger>Deployment du portfolio</AccordionTrigger>
...
`}
        ...
        <div className="mt-12">
          ...
          <div className="mt-5 rounded-2xl border border-neutral-700 bg-neutral-950 p-6">
            <code className="text-green-400">replicas: 3</code>
          </div>

          <p className="mt-5 leading-7 text-neutral-300">
            Le portfolio est exécuté simultanément dans{" "}
            <span className="font-semibold text-green-400">trois Pods</span>.
          </p>

          <p className="mt-4 leading-7 text-neutral-300">
            Cette configuration améliore la disponibilité de l&apos;application.
            Si l&apos;un des Pods disparaît à cause d&apos;une panne ou
            d&apos;un redémarrage de nœud, Kubernetes détecte automatiquement la
            situation et crée un nouveau Pod pour maintenir le nombre de
            réplicas souhaité.
          </p>
          <p>
            <img
              src="/labs/02/deployment-replicas.png"
              alt="Schéma illustrant le fonctionnement des réplicas dans un Deployment Kubernetes"
          ...
          <div className="mt-8 rounded-2xl border border-green-500/20 bg-green-500/10 p-6">
            ...
            <p className="mt-4 leading-7 text-green-100">
              ...
              Kubernetes à partir de l&apos;image produite dans le Lab 01.
              Kubernetes garantit automatiquement le maintien des Pods et
              prépare l&apos;application à être exposée au reste du réseau dans
