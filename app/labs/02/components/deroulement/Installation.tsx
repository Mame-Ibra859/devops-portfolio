        ...
        <section>
            ...
            <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6 lg:p-10">
                ...
                <p className="mt-4 text-sm leading-7 text-neutral-300 sm:mt-6 sm:text-base sm:leading-8">
                    Avant de pouvoir déployer l'application, il est
                    nécessaire de disposer d'une plateforme Kubernetes.
                    Pour ce laboratoire, le choix s'est porté sur
                    <span className="font-semibold text-white"> K3s</span>,
                    une distribution légère de Kubernetes parfaitement
                    adaptée à un déploiement sur VPS tout en restant
                    entièrement compatible avec l'écosystème Kubernetes.
                </p>
...
vps-732fcaac     Ready    control-plane   v1.33.x+k3s`}
                    ...
                    <p className="mt-4 text-sm leading-7 text-cyan-100 sm:mt-5 sm:text-base">
                        ...
                        Le cluster est maintenant opérationnel. Il servira
                        de plateforme d'exécution pour l'ensemble des
                        ressources Kubernetes déployées dans ce laboratoire.
