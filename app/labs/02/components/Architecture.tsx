  ...
  return (
    <section className="space-y-5 sm:space-y-6">
      ...
      <p className="max-w-4xl text-sm leading-7 text-neutral-400 sm:text-base">
        L'application est déployée sur une plateforme Kubernetes K3s installée
        sur un VPS. Les utilisateurs accèdent au portfolio via un Ingress.
        Celui-ci redirige les requêtes vers un Service Kubernetes qui répartit
        automatiquement le trafic entre plusieurs Pods. Une base PostgreSQL est
        déployée indépendamment dans un StatefulSet afin de conserver les
      ...
      <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6 md:p-8">
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-stretch">
          ...
          <div className="flex items-center justify-center px-2 xl:px-0">
            <ArrowRight
              className="hidden text-neutral-500 xl:block"
              size={24}
            />
          </div>
            ...
            <div className="grid gap-3 lg:grid-cols-[1.2fr_0.8fr]">
              <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                {pods.map((pod) => (
                  ...
                  >
                    <Server className="mx-auto mb-2 text-cyan-400" size={24} />
          ...
          <div className="rounded-2xl border border-orange-500/60 bg-orange-500/10 p-4 xl:w-[240px]">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-xl border border-neutral-700 bg-neutral-950/80 p-3 text-center">
                <Database className="mx-auto mb-2 text-cyan-400" size={24} />
                <h5 className="font-medium">StatefulSet</h5>
                <p className="mt-1 text-sm text-neutral-500">PostgreSQL 16</p>
              </div>

              <div className="rounded-xl border border-neutral-700 bg-neutral-950/80 p-3 text-center">
                <HardDrive className="mx-auto mb-2 text-cyan-400" size={24} />
                <h5 className="font-medium">PersistentVolumeClaim</h5>
